		...
		loadShip(){
			...
			util.loadShipJSON(this.ship, function(response, shipname){
					...
					if (self.skin != null){
						...
						if (self.retrofit == "true")
							self.shipIcon = "http://media.alg-wiki.com/Ships/" + actual_JSON.file_id + "/Icon/skin"+actual_JSON.retroParameter.split(",")[2].trim()+"_half.png";
						else
							self.shipIcon = "http://media.alg-wiki.com/Ships/" + actual_JSON.file_id + "/Icon/skin"+self.skin+"_half.png";
					} else {
						if (self.retrofit == "true")
							self.shipIcon = "http://media.alg-wiki.com/Ships/" + actual_JSON.file_id + "/Icon/skin"+actual_JSON.retroParameter.split(",")[2].trim()+"_half.png";
						else
							self.shipIcon = "http://media.alg-wiki.com/Ships/" + actual_JSON.file_id + "/Icon/skin1_half.png";
					}
...
class IconDisplay extends HTMLElement{
	...
	loadShip(){
		...
		util.loadShipJSON(this.ship, function(response, shipname){
			var actual_JSON = JSON.parse(response);
			self.icon = "http://media.alg-wiki.com/Ships/" + actual_JSON.file_id + "/Icon/icon.png";
            ...
            <tr>
                <td style="text-align:left;height:1px;">
                    <table class="wikitablewide" style="width:100%;height:100%;text-align:left;margin:0 0 0 0;">
                        ...
                        <tr>
                            <td rowspan="2" style="width: 20%; padding: 10px; text-align: center;"><a href ="ship#${this.bossShip[0]}" style="text-decoration:none;color:white"><img src="http://media.alg-wiki.com/qicon/${this.bossShip[0]}.png" style="width: 64px; height: 64px"><br>${this.bossShip[1]}</a></td>
