...
(function (pixiTaihou) {
    PIXI.loader
        .add('moc', "https://media.alg-wiki.com/Ships/Plan003_Ibuki/Live2D/yichui_2.moc3", { xhrType: PIXI.loaders.Resource.XHR_RESPONSE_TYPE.BUFFER })
        .add('texture', "https://media.alg-wiki.com/Ships/Plan003_Ibuki/Live2D/texture_00.png")
        ...
        var app = new PIXI.Application(995, 1202, { transparent: true });
        ...
        var onResize = function (event) {
            ...
            model.scale = new PIXI.Point((model.position.x * 0.11), (model.position.x * 0.11));
